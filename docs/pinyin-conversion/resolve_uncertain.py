...
# ลบ lop~ 減：來源 Thai.A.7.6 講義「1. บวก/ลบ/คูณ/หาร」例句截圖（job 260828，
# 260828-1.mp4 約 2:58），官方羅馬拼音照抄，不套一般規則。
SYL_FIX['ลบ'] = 'lop~'
# ขนาด ka.nātˇ …的程度：來源同上，講義「4. ขนาด」例句截圖（約 30:34）。
SYL_FIX['ขนาด'] = 'ka.nātˇ'
# อักษร akˇsɔ̆n´ 字母：來源同上，講義「2. คล้าย 相似」例句截圖（job 260828，
# 260828-2.mp4 約 7:30），官方羅馬拼音照抄，不套一般規則。
SYL_FIX['อักษร'] = 'akˇsɔ̆n´'
