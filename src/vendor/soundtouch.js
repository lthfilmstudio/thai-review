/* Vendored verbatim, unmodified, from soundtouchjs v0.3.0.
   Source: https://unpkg.com/soundtouchjs@0.3.0/dist/soundtouch.js
   Project: https://github.com/cutterbl/SoundTouchJS
   License: LGPL-2.1 — see https://github.com/cutterbl/SoundTouchJS/blob/master/LICENSE.md
   Used here for: pitch-preserving (WSOLA) time-stretch of Thai teacher-voice
   audio when playback rate != 1. Only the low-level SoundTouch/SimpleFilter/
   WebAudioBufferSource classes are used (offline, synchronous) — NOT the
   PitchShifter live-playback wrapper. Do not hand-edit; replace wholesale
   on upgrade. */
